#!/usr/bin/env python3
"""
Final verification script for StopConsumer integration
...
# Import the consumers directly without Django setup
from src.core.EchoConsumer import EchoConsumer, AsyncEchoConsumer
